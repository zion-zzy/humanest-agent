...
| **A tool is missing, renamed, or its schema disagrees with the skill** | Stop and report — never guess a substitute or invent arguments. **The tool's own runtime description wins over the skill**, which can be out of date. Show your member the tools you actually see, and check whether a newer version of this skill exists. |
